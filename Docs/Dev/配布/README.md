...
リリースと利用者への配布方法に関する調査と手順をここにまとめます。

2026-09-26 から Smart App Control をオフにする運用です。自己署名とビルド前の `bin`・`obj` 削除は廃止しました。現行の発行・ZIP 作成は[リリース手順](リリース手順.md)、旧処理は[廃止記録](../Archive/RetiredSmartAppControl/README.md)を参照してください。
...
| [コード署名](../Troubleshooting/SmartAppControl/%E3%82%B3%E3%83%BC%E3%83%89%E7%BD%B2%E5%90%8D.md) | 廃止した自己署名処理と証明書の調査記録 |
| [リリース手順](リリース手順.md) | 現在の署名なし ZIP 作成・更新手順 |
